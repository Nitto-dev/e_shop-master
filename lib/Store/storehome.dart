        ...
        body: CustomScrollView(
          ...
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("items").limit(30).orderBy("publishedDate",descending: true).snapshots(),
            ...
            children: [
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    Expanded(child: Text(
                      model.title, style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.w500),
                    ),
                    ),
                  ],
                ),
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    Expanded(child: Text(
                      model.shortInfo, style: TextStyle(color: Colors.grey,fontSize: 12.0),
                    ),
                    ),
                  ],
                ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      child: Row(
                        children: [
                          Text(r"Original Price: ৳ ",style: TextStyle(fontSize: 14.0,
                          color: Colors.grey,
                            decoration: TextDecoration.lineThrough,
                          ),
                          ),
                          Text((model.price + model.price).toString(),style: TextStyle(fontSize: 15.0,
                            color: Colors.grey,
                            decoration: TextDecoration.lineThrough,
                          ),
                          )
                      ...
                      Padding(padding: EdgeInsets.only(top: 5.0),
                        child: Row(
                          children: [
                            Text(r"New Price: ",style: TextStyle(fontSize: 14.0,
                              color: Colors.grey,
...
Widget card({Color primaryColor = Colors.redAccent, String imgPath}) {
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: <BoxShadow>[BoxShadow(offset: Offset(0,5),blurRadius: 10.0,color: Colors.grey[200]),
      ]
    ),
    child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(20.0)),
...
addItemToCart(String shortInfoAsID, BuildContext context)
{
  ...
  EcommerceApp.firestore.collection(EcommerceApp.collectionUser).document(EcommerceApp.sharedPreferences.getString(EcommerceApp.userUID)).updateData({EcommerceApp.userCartList: tempCartList,}).then((v){
