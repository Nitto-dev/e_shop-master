...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  takeImage(mContext)
  {
    ...
    {
      return SimpleDialog(
        title: Text("Item Image",style: TextStyle(color: Colors.white,fontSize:20.0),),
        children: [
          SimpleDialogOption(
  ...
  {
    Navigator.pop(context);
    File imageFile = await ImagePicker.pickImage(source: ImageSource.camera,imageQuality: 30,maxHeight: 680.0,maxWidth: 970.0);
  ...
  {
    Navigator.pop(context);
    File imageFile = await ImagePicker.pickImage(source: ImageSource.gallery,imageQuality: 30);
