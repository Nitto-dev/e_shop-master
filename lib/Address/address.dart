...
class AddressCard extends StatefulWidget {
  ...
  const AddressCard({Key key, this.model, this.addressId, this.totalAmount, this.currentIndex, this.value}) : super(key: key);
...
class KeyText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text(msg, style: TextStyle(fontWeight: FontWeight.bold),);
  }
}
